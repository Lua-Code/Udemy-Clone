      ...
      <div className="bg-[#20222f] rounded-xl overflow-hidden shadow-lg py-12 px-5 hover:shadow-2xl transition-shadow duration-300 flex flex-col md:flex-row h-auto">
        ...
        <div className="md:w-1/2 p-8 flex flex-col justify-center">
            ...
            <div className="flex items-center gap-2">
                <div className="bg-[#d2c9ff] p-2 rounded-full flex items-center justify-center">
                <Stars size={16} className="text-[#20222f]" />
                </div>
                <p className="text-white text-xs font-light">Learn AI and more</p>
            </div>

            <div className="flex items-center gap-2">
                <div className="bg-[#bce7d3] p-2 rounded-full flex items-center justify-center">
                <Trophy size={16} className="text-[#20222f]" />
                </div>
                <p className="text-white text-xs font-light">Prep for a certification</p>
            </div>

            <div className="flex items-center gap-2">
                <div className="bg-[#ffe0ad] p-2 rounded-full flex items-center justify-center">
                <MessageSquare size={16} className="text-[#20222f]" />
                </div>
                <p className="text-white text-xs font-light">Practice with AI coaching</p>
            </div>

            <div className="flex items-center gap-2">
                <div className="bg-[#c4ebee] p-2 rounded-full flex items-center justify-center">
                <Lightbulb size={16} className="text-[#20222f]" />
                </div>
            ...
            <button className="bg-white text-black px-5 py-2 rounded-lg font-medium hover:bg-black-500 w-40 mb-2">
                Learn More
            </button>
