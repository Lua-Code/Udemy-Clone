const CourseCard = ({ img, title, careers, price }) => {
  return (
    <div className="bg-gray-50 rounded-xl pt-5 px-5 overflow-hidden shadow hover:shadow-lg cursor-pointer transition-shadow duration-300">
      <img src={img} alt={title} className="rounded-xl  h-36 sm:h-40 md:h-48 object-cover" />
